...
module Fog
  module Hadoop
    class Collection < Fog::Collection
      ...
      def all(options = {})
        raise Fog::Hadoop::Errors::InterfaceNotImplemented.new('Method :all is not implemented')
      end
      ...
      def get(uuid)
        raise Fog::Hadoop::Errors::InterfaceNotImplemented.new('Method :get is not implemented')
      end
      ...
      def destroy(uuid)
        raise Fog::Hadoop::Errors::InterfaceNotImplemented.new('Method :destroy is not implemented')
      end
    end
  end
end
